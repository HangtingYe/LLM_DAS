...
# Keep imports minimal for this project to avoid pulling heavy/optional
# backends that are irrelevant to the current reproduction setting.
    ...
    def __init__(self, seed, model_name, tune=False):
        ...
        if self.model_name not in self.model_dict:
            raise NotImplementedError(
                f"Model '{self.model_name}' is not enabled in this lightweight reproduction build. "
                "Supported models: IForest, OCSVM, ECOD, PCA."
            )
